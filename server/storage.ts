...
export class MemStorage implements IStorage {
  ...
  private seed() {
    ...
    const sessionData = [
      ...
      { number: 2, name: "День 2 — Действия", description: "Углубление связи с интуитивными подсказками." },
      { number: 3, name: "День 3 — Разум", description: "Переход от идей к конкретным шагам." },
      { number: 4, name: "День 4 — Энергия", description: "Масштабирование действий и реализация." },
      { number: 5, name: "День 5 — Синтез", description: "Логический анализ и структурирование." },
      { number: 6, name: "День 6 — Мастерство", description: "Стратегическое планирование и ментальные установки." },
      { number: 7, name: "День 7 — Реализация", description: "Наполнение энергией и завершение цикла." }
    ];
